...
| [`docs/ugcp/ANDROID_UGCP_CONSTITUTION.md`](docs/ugcp/ANDROID_UGCP_CONSTITUTION.md) | Android-side UGCP constitution, canonical vocabulary, and control-plane phase/field alignment |
