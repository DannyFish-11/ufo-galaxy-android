 ...
 * // SECURITY: Always use wss:// (TLS-encrypted) in production.
 * // ws:// is only acceptable for localhost/debug builds and must never be used
 * // on physical devices or production networks.
 * val url = "wss://galaxy.ufo.ai/ws/webrtc/$deviceId"
