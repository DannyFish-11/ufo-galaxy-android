...
import com.ufo.galaxy.runtime.AndroidPresenceProjectionLayer
...
import com.ufo.galaxy.protocol.StateEventPayload
...
class GalaxyConnectionService : Service() {
    ...
    companion object {
        ...
        private val NOTIFICATION_ID = ("GalaxyConnectionService".hashCode() and 0x7FFFFFFF) % 10000 + 1000
    ...
    private val serviceScope = CoroutineScope(
        Dispatchers.IO + SupervisorJob() + CoroutineName("GalaxyConnectionService")
    )
    ...
    // These handlers reduce the size of GalaxyConnectionService and separate concerns.
    ...
    // C9-FIX: Use the shared PhaseStateMachine from UFOGalaxyApplication so that
    ...
    val phaseStateMachine: PhaseStateMachine
        get() = UFOGalaxyApplication.phaseStateMachine
