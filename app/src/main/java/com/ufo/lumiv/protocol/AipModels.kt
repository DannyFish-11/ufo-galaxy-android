...
enum class MsgType(val value: String) {
     ...
     *  Payload model: [com.ufo.lumiv.agent.TakeoverRequestEnvelope].
     *  @status pr15-complete — full delegated takeover executor path closed:
     *  eligibility gate ([com.ufo.lumiv.agent.TakeoverEligibilityAssessor]),
     *  session gate ([com.ufo.lumiv.agent.DelegatedRuntimeReceiver]),
     *  canonical executor ([com.ufo.lumiv.agent.DelegatedTakeoverExecutor]) emitting
     *  ACK / PROGRESS / RESULT signals with stable identity and [com.ufo.lumiv.runtime.EmittedSignalLedger];
     *  structured rejection for all ineligible paths; timeout/cancellation/failure outcomes
     *  distinguished and forwarded to [com.ufo.lumiv.runtime.RuntimeController.notifyTakeoverFailed]. */
    TAKEOVER_REQUEST("takeover_request"),

    /** Uplink: Android responds to a [TAKEOVER_REQUEST] with acceptance or rejection.
     *  Payload model: [com.ufo.lumiv.agent.TakeoverResponseEnvelope].
     *  @status pr15-complete — accepted/rejected response sent with structured rejection_reason,
     *  runtime_host_id, and formation_role; send path present via LumivConnectionService. */
     ...
     *  @status pr16 — payload defined; send path present via LumivConnectionService. */
    ...
    /** Downlink: V2 sends a [com.ufo.lumiv.agent.HandoffEnvelopeV2] envelope to Android
     ...
     *  Payload model: [com.ufo.lumiv.agent.HandoffEnvelopeV2].
     *  @status pr-h — promoted; dedicated stateful handler in LumivConnectionService. */
     ...
     *  @status pr-h — payload defined; send path present via LumivConnectionService. */
     ...
     *  RUNTIME_TRUTH_SNAPSHOT (and all other [com.ufo.lumiv.runtime.ReconciliationSignal.Kind])
     *  events from [com.ufo.lumiv.runtime.RuntimeController.reconciliationSignals].
     *  Payload model: [ReconciliationSignalPayload].
     *  @status pr-06 — payload defined; send path present via LumivConnectionService. */
    RECONCILIATION_SIGNAL("reconciliation_signal"),

    // ── Android-side signal closure: readiness artifact uplink ───────────────────────────────
    // Uplink message that carries the structured [com.ufo.lumiv.runtime.DeviceReadinessArtifact]
    // and per-dimension [com.ufo.lumiv.runtime.DelegatedRuntimeReadinessSnapshot] produced by
    // [com.ufo.lumiv.runtime.DelegatedRuntimeReadinessEvaluator].
     ...
     *  @status android-closure — payload defined; send path present via LumivConnectionService. */
     ...
     *  @status pr-4-android — payload defined; send path present via LumivConnectionService. */
    ...
    // [com.ufo.lumiv.runtime.AndroidDelegatedRuntimeAudit].
     ...
     *  @status pr-rt — payload defined; send path wired in LumivConnectionService. */
     ...
     *  @status pr-2-android — payload defined; send path wired in LumivConnectionService. */
     ...
     *  @status pr-7-android — payload defined; send path wired in LumivConnectionService. */
    DEVICE_PERCEPTION_EMISSION("device_perception_emission"),

    // ── PR-CROSS-SYNC: Cross-device state event (V2 → Android) ───────────────────────────
    /** Downlink: V2 broadcasts a state event to all connected Android devices.
     *  Carries phase transitions (SILENT → LIMINAL → MANIFEST), task lifecycle updates,
    ...
    companion object {
         ...
         * before messages are sent via [com.ufo.lumiv.input.InputRouter], the sole canonical
         ...
         * [LumivWebSocketClient] and [LumivConnectionService], except for the three types
         ...
         * dedicated sequence-aware [CoordSyncAckPayload] response via [LumivConnectionService].
        ...
        val ACK_ON_RECEIPT_TYPES: Set<MsgType> = setOf(
            ...
            TAKEOVER_REQUEST,
            // PR-SANDBOX: CODE_EXECUTE now has dedicated handler
            CODE_EXECUTE
        )
    }
}
 ...
 *                            in [com.ufo.lumiv.runtime.SourceRuntimePosture]:
 ...
 *                   [com.ufo.lumiv.runtime.AndroidNlInitiationContract.NlInitiationMode].
 ...
 *                   [com.ufo.lumiv.runtime.AndroidNlInitiationContract.NlAuthorityScope].
...
data class TaskSubmitPayload(
     ...
     *
     * Callers (e.g. [com.ufo.lumiv.input.InputRouter]) should call [validate] before
 ...
 *                            in [com.ufo.lumiv.runtime.ContinuityRecoveryContext]:
 ...
 *                       envelope. Populated by [LumivConnectionService] before sending.
 ...
 *                       Populated by [LumivConnectionService] before sending.
 ...
 *                         [com.ufo.lumiv.runtime.ExecutorTargetType]:
 ...
 *                            [com.ufo.lumiv.runtime.ExecutionContractCompatibilityValidator.DispatchStrategyHint]:
 ...
 *                            [com.ufo.lumiv.runtime.AndroidDelegatedFlowBridge.delegatedFlowId].
 ...
 *                       [com.ufo.lumiv.runtime.PolicyRoutingContext.RoutingOutcome.REJECTED].
 ...
 *                       [com.ufo.lumiv.runtime.PolicyRoutingContext.RESULT_STATUS_HOLD].
 *                       Set to [com.ufo.lumiv.runtime.PolicyRoutingContext.RESULT_HOLD_REASON_TEMPORARILY_UNAVAILABLE]
 *                       when the outcome is
 *                       [com.ufo.lumiv.runtime.PolicyRoutingContext.RoutingOutcome.TEMPORARILY_UNAVAILABLE],
 ...
 *                       ([com.ufo.lumiv.runtime.PolicyRoutingContext.RoutingOutcome.RESUMED]).
 ...
 *                       [com.ufo.lumiv.service.LumivConnectionService.sendGoalResult] at
 ...
 *                       [com.ufo.lumiv.service.LumivConnectionService.sendGoalResult]
 *                       from [com.ufo.lumiv.UFOLumivApplication.runtimeSessionId] at
...
data class GoalResultPayload(
    ...
    // Both fields are set by LumivConnectionService.sendGoalResult at emission time and are
    // null only for pre-emission / locally-constructed payloads.
    ...
    // Populated by LumivConnectionService.sendGoalResult from the `result` field when absent.
    val result_summary: String? = null,
    ...
    // Null only as defensive defaults; LumivConnectionService.sendGoalResult fills these.
    ...
    //   Null 仅作为防御性默认值；LumivConnectionService.sendGoalResult 在发送时填充。
    //
    ...
    //   Null only as a defensive default; LumivConnectionService.sendGoalResult fills this.
    //
 ...
 *
 * Carries a reconciliation lifecycle signal from [com.ufo.lumiv.runtime.RuntimeController.reconciliationSignals]
 ...
 * @param kind                 Wire discriminator from [com.ufo.lumiv.runtime.ReconciliationSignal.Kind.wireValue]:
 ...
 * @param status               Wire-level status matching [com.ufo.lumiv.runtime.ReconciliationSignal]
 ...
 *                             Contains the serialised [com.ufo.lumiv.runtime.AndroidParticipantRuntimeTruth]
 ...
 * | [task_id]                | Echoed from [com.ufo.lumiv.agent.HandoffEnvelopeV2.task_id]      |
 * | [trace_id]               | Echoed from [com.ufo.lumiv.agent.HandoffEnvelopeV2.trace_id]     |
 ...
 * [com.ufo.lumiv.runtime.DelegatedRuntimeReadinessEvaluator] toward V2 release-gate and
 ...
 *
 * @param artifact_tag        Stable wire-tag of the [com.ufo.lumiv.runtime.DeviceReadinessArtifact].
 ...
 * [com.ufo.lumiv.runtime.DelegatedRuntimePostGraduationGovernanceEvaluator] toward V2
 ...
 * [com.ufo.lumiv.runtime.DelegatedRuntimePostGraduationGovernanceEvaluator]:
 *
 * | [artifact_tag]                                                    | Meaning                                                               |
 * |-------------------------------------------------------------------|-----------------------------------------------------------------------|
 ...
 * post-graduation governance evaluation path in LumivConnectionService.  V2 may treat
 ...
 *
 * @param artifact_tag          Stable wire-tag of the [com.ufo.lumiv.runtime.DeviceGovernanceArtifact].
 ...
 * produced by [com.ufo.lumiv.runtime.DelegatedRuntimeAcceptanceEvaluator] toward V2
 ...
 *
 * [artifact_tag] uses the stable wire-tag constants from
 * [com.ufo.lumiv.runtime.DelegatedRuntimeAcceptanceEvaluator]:
 *
 * | [artifact_tag]                                       | Meaning                                                            |
 * |------------------------------------------------------|--------------------------------------------------------------------|
 ...
 *
 * This artifact is **canonical participant evidence** when produced from a live
 * acceptance evaluation path in LumivConnectionService.  V2 graduation gate must treat
 * `device_accepted_for_graduation` as an authoritative graduation readiness signal.
 *
 * @param artifact_tag          Stable wire-tag of the [com.ufo.lumiv.runtime.DeviceAcceptanceArtifact].
 ...
 * posture snapshot produced by [com.ufo.lumiv.runtime.DelegatedRuntimeStrategyEvaluator]
 ...
 *
 * [artifact_tag] uses the stable wire-tag constants from
 * [com.ufo.lumiv.runtime.DelegatedRuntimeStrategyEvaluator]:
 *
 * | [artifact_tag]                                                    | Meaning                                                         |
 * |-------------------------------------------------------------------|-----------------------------------------------------------------|
 ...
 *
 * @param artifact_tag          Stable wire-tag of the [com.ufo.lumiv.runtime.DeviceStrategyArtifact].
 ...
 * snapshot produced by [com.ufo.lumiv.runtime.AndroidDelegatedRuntimeAudit] toward V2
 ...
 * contains all fields from [com.ufo.lumiv.runtime.AndroidDelegatedRuntimeAuditSnapshot.toWireMap].
 *
 * @param evidence_tag          Stable wire-tag of the [com.ufo.lumiv.runtime.AndroidDelegatedRuntimeAuditEvidence].
 ...
 * @param wire_map              The full [com.ufo.lumiv.runtime.AndroidDelegatedRuntimeAuditSnapshot.toWireMap]
 ...
 *
 * Local loop config (from [UFOLumivApplication.localLoopConfig]):
 ...
 * @param offline_queue_depth        Current depth of the offline task queue ([LumivWebSocketClient.queueSize]).
 ...
 *                                   [com.ufo.lumiv.config.FallbackConfig.enablePlannerFallback]:
 ...
 *                                   [com.ufo.lumiv.config.FallbackConfig.enableGroundingFallback]:
 ...
 *                                   [com.ufo.lumiv.runtime.DurableSessionContinuityRecord.durableSessionId].
 ...
 *                                   [com.ufo.lumiv.runtime.DurableSessionContinuityRecord.sessionContinuityEpoch].
 *                                   `null` when [durable_session_id] is `null`.
 * @param runtime_session_id         Per-app-launch runtime session UUID from
 *                                   [com.ufo.lumiv.UFOLumivApplication.runtimeSessionId].
 ...
 *                                   [com.ufo.lumiv.runtime.AttachedRuntimeSession.sessionId].
 ...
 *                                   [com.ufo.lumiv.runtime.RuntimeController.appForegroundVisible].
 ...
 *                                   [com.ufo.lumiv.runtime.CrossDeviceEnablementError] and
 *                                   [com.ufo.lumiv.agent.TakeoverEligibilityAssessor].
 *
 * Final Android carrier consolidation fields (PR-10):
 * @param carrier_runtime_state      Wire label of [com.ufo.lumiv.runtime.RuntimeController.state]
 ...
 * @param reconnect_recovery_state   Wire value of [com.ufo.lumiv.runtime.RuntimeController.reconnectRecoveryState]
 ...
 *                                   from [com.ufo.lumiv.runtime.AndroidReconnectRecoveryParticipationContract].
 ...
 * [com.ufo.lumiv.runtime.CapabilityAuthoritySnapshot] that V2 can use for dispatch
 ...
 *                                   Matches [com.ufo.lumiv.runtime.CapabilityAuthoritySnapshot.SCHEMA_VERSION].
 *                                   Allows V2 to detect Android-side schema changes across releases.
 * @param local_intelligence_status  Wire value of [com.ufo.lumiv.runtime.LocalIntelligenceCapabilityStatus]
...
data class DeviceStateSnapshotPayload(
    ...
    val evidence_presence_kind: String? = null,
     ...
     //   com.ufo.lumiv.runtime.AndroidOperationalStateSurfaceContract.SCHEMA_VERSION.
     //
    ...
    //   com.ufo.lumiv.runtime.AndroidRuntimeObservabilityAuditContract.SCHEMA_VERSION.
    //
    ...
    //   Null 仅作为防御性默认值；LumivConnectionService 在 sendDeviceStateSnapshot() 时填充。
    //
    ...
    //   Null 仅作为防御性默认值；LumivConnectionService.sendDeviceStateSnapshot() 在发送时填充。
    //
 ...
 *                             (e.g. `"LumivConnectionService"`, `"LoopController"`).
...
data class DeviceExecutionEventPayload(
    ...
    // Null only as a defensive default; LumivConnectionService fills these at event emission.
    val result_returned: Boolean? = null,
    val completion_signaled: Boolean? = null,
    val closure_ready_for_acceptance: Boolean? = null,
    ...
    //   Null 仅作为防御性默认值；LumivConnectionService 在事件发射时填充。
    val unified_lifecycle_phase: String? = null,
    val unified_lifecycle_schema_version: String? = null,
    ...
    //   Null 仅作为防御性默认值；LumivConnectionService.deviceExecutionEventSink 在发射时填充。
    //
...
// ── On-Device Code Execution (CODE_EXECUTE / CODE_RESULT) ─────────────────────────────

/**
 * Downlink payload for [MsgType.CODE_EXECUTE].
 *
 * Carries a code snippet to be executed inside the on-device sandbox.
 *
 * @param task_id          Task identifier echoed in the result.
 * @param code             Code snippet to execute (JavaScript/Python-like).
 * @param language         Language hint: `"javascript"` | `"python"` | `"kotlin_script"`.
 * @param timeout_ms       Maximum execution time in milliseconds (default 5000).
 * @param max_output_chars Maximum output length to prevent memory exhaustion.
 * @param environment_vars Optional environment variables as key-value pairs.
 * @param correlation_id   Echoed from the originating AipMessage for request/response pairing.
 */
data class CodeExecutePayload(
    val task_id: String,
    val code: String,
    val language: String = "javascript",
    val timeout_ms: Long = 5000L,
    val max_output_chars: Int = 10000,
    val environment_vars: Map<String, String> = emptyMap(),
    val correlation_id: String = ""
)

/**
 * Uplink payload for [MsgType.CODE_RESULT].
 *
 * Carries the result of on-device code execution back to the gateway.
 *
 * @param task_id        Echoed from [CodeExecutePayload.task_id].
 * @param correlation_id Echoed from the originating request.
 * @param status         Execution status: `"success"` | `"error"` | `"timeout"` | `"blocked"`.
 * @param output         stdout/result output from the sandbox (truncated to max_output_chars).
 * @param error          Error message if status is not `"success"`.
 * @param exit_code      Process/sandbox exit code (0 = success).
 * @param execution_ms   Actual wall-clock execution time in milliseconds.
 * @param device_id      Device that executed the code.
 */
data class CodeResultPayload(
    val task_id: String,
    val correlation_id: String = "",
